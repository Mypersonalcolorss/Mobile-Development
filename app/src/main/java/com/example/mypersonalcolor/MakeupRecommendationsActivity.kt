...
class MakeupRecommendationsActivity : AppCompatActivity() {
    private lateinit var adapter: DressRecommendationsAdapter

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_makeup_recommendations)
    ...
    private fun fetchDressRecommendations() {
        ...
        val url = "https://server-utqhuaf4va-et.a.run.app/getUserMakeup/$userId"
        ...
        OkHttpClient().newCall(request).enqueue(object : Callback {
            override fun onFailure(call: Call, e: IOException) {
                ...
                runOnUiThread {
                    Toast.makeText(this@MakeupRecommendationsActivity, "Error: ${e.message}", Toast.LENGTH_LONG).show()
                }
            }
            ...
            override fun onResponse(call: Call, response: Response) {
                ...
                if (!response.isSuccessful) {
                    ...
                    runOnUiThread {
                        Toast.makeText(this@MakeupRecommendationsActivity, "Error: $responseBody", Toast.LENGTH_LONG).show()
                    }
                } else {
                    try {
                        ...
                        runOnUiThread {
                            Toast.makeText(this@MakeupRecommendationsActivity, "Error parsing response", Toast.LENGTH_SHORT).show()
                        }
                    }
                }
            }
